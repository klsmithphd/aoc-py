from aoc2022.day11 import parse, Monkey, turn, round
...
def test_turn():
    assert (1,
            [[],
             [54, 65, 75, 74],
             [79, 60, 97],
             [74, 500, 620]]) == turn(d11_s01['monkeys'], (0, d11_s01['items']))
    assert (2,
            [[20, 23, 27, 26],
             [],
             [79, 60, 97],
             [74, 500, 620]]) == turn(d11_s01['monkeys'],
                                      (1,
                                       [[],
                                        [54, 65, 75, 74],
                                           [79, 60, 97],
    ...
    assert (3,
            [[20, 23, 27, 26],
             [2080],
             [],
             [74, 500, 620, 1200, 3136]]) == turn(d11_s01['monkeys'],
                                                  (2,
                                                   [[20, 23, 27, 26],
                                                    [],
                                                       [79, 60, 97],
