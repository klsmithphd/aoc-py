from aoc2022.day04 import day04_soln, parse, isfully_contained, isoverlapping,\
    fully_contained_count, overlapping_count
...
def test_overlapping_count():
    assert 4 == overlapping_count(parse(d04_sample))
...
def test_day04_part2_soln():
    assert 933 == day04_soln.part2(d04_input)
